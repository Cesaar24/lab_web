...
<template>
  <div v-if="show" class="flex flex-col gap-3">
    <div
      v-if="success"
      class="flex bg-white items-center px-6 py-4 text-sm border-t-2 rounded-b shadow-sm border-green-500"
    >
      <svg
    ...
    <div
      v-else
      class="flex bg-white items-center px-6 py-4 text-sm border-t-2 rounded-b shadow-sm border-red-500"
    >
      <svg
        viewBox="0 0 24 24"
